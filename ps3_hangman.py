...
def getGuessedWord(secretWord, lettersGuessed):
    ...
    strng = ''
    for letter in secretWord :
        if letter in lettersGuessed : strng += letter
        else : strng += '_'
    return strng
...
def getAvailableLetters(lettersGuessed):
    ...
    for letter in string.ascii_lowercase :
        if letter not in lettersGuessed : strng += letter
    return strng
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    guesses = 8
    guessedLetters = ''
    while not (isWordGuessed(secretWord,guessedLetters)) and guesses != 0 :
        print ("------------")
        ...
        if char.lower() in guessedLetters :
            ...
            continue
        guessedLetters += char.lower()
        if char.lower() in secretWord :
            ...
            guesses -= 1
    print("------------")
    if    isWordGuessed(secretWord,guessedLetters) : print("Congratulations, you won!")
